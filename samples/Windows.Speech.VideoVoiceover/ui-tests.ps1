...
$logDir = "D:\source\ttslib-extract\samples\Windows.Speech.VideoVoiceover\bin\Release\net10.0-windows10.0.26100.0\win-arm64"
$log = Join-Path $logDir 'voiceover.log'
$shotDir = "D:\source\ttslib-extract\samples\Windows.Speech.VideoVoiceover\screenshots"
